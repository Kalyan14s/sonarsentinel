...
| D4 | S3Simulator | None published | ❌ | 2026-09-13 | No LICENSE in NambiarAthira/S3Simulator (commit 6be5323) | Excluded from training, manifests and DVC unless written permission (see §Permissions). Repository sample files (41 MB) kept locally in `data/raw/s3simulator` for private evaluation only | Kamal Basha & Nambiar, ICPR 2024 |
